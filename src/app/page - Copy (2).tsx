...
function FAQTop6() {
  ...
  const items = [
    ...
    {
      q: 'What can go wrong during minting?',
      a: 'The most common issues are not enough SOL, rejecting the wallet popup, network congestion, or refreshing the page during mint. If a mint fails, no NFT is created unless the blockchain confirms the transaction.',
    },
    {
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 18, flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          <div style={{ flex: '1 1 320px', display: 'flex', flexDirection: 'column', gap: 12 }}>
            ...
            <div style={{ color: 'rgba(255,255,255,0.9)', lineHeight: 1.7, fontSize: 15 }}>
            ...
            <div style={{ color: 'rgba(255,255,255,0.82)', lineHeight: 1.7, fontSize: 14 }}>
        ...
        >
          ...
          <Section id="top" style={bg('01')}>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
              <div style={{ color: 'rgba(255,255,255,0.78)', fontSize: 14, fontWeight: 700 }}>
              ...
              >
                ...
                <br />
                <br />
                <strong>ISHVA turns that recognition into participation.</strong>
                <br />
                <br />
                The launch begins with <strong>888 unique NFTs</strong> for those who choose to participate early.
              </div>

              <div style={{ color: 'rgba(255,255,255,0.68)', fontSize: 13, fontWeight: 600 }}>
          ...
          <Section id="vision" style={bg('03')}>
            <h2 style={{ margin: 0, color: 'white', fontSize: 30, fontWeight: 900 }}>Vision</h2>
            ...
            >
              ...
              >
                Participation helps sustain what continues.
              </div>
              ...
              >
                Ishvara gives direction.
                <br />
                ISHVA sustains what follows.
              </div>
          ...
          <Section id="faq" style={bg('04')}>
            <h2 style={{ margin: 0, color: 'white', fontSize: 30, fontWeight: 900 }}>FAQ</h2>
            <div style={{ color: 'rgba(255,255,255,0.8)', lineHeight: 1.7, fontSize: 15 }}>
